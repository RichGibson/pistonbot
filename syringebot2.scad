...
module plate() {
    cube( [frame_length*t+t, frame_width/2, plate_thickness] );
}
...
frame();
translate( [-t,t,frame_height*t]) motor_plate();
translate([0,0,frame_height/2*t]) cross_bars();
translate( [-t,t,frame_height/2*t+plate_thickness]) plate();
